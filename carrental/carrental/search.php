...
where tblvehicles.VehiclesTitle=:search || tblvehicles.FuelType=:search || tblbrands.BrandName=:search || tblvehicles.ModelYear=:search || tblvehicles.Category=:search || tblvehicles.Fulltank=:search";
...
$cnt=$query->rowCount();
?>
<p><span><?php echo htmlentities($cnt);?> Listings found from the search</span></p>
</div>
</div>
