...
$sql="update tblusers set FullName=:name,ContactNo=:mobileno,dob=:dob,Address=:adress,City=:city,Country=:country,LicenseNo=:license where EmailId=:email";
...
<section class="user_profile inner_pages">
  <div class="container">
    ...
    <div class="upload_user_logo" style="position: relative;">
    <img src="uploadsProfile/<?php echo htmlentities($result->profileImage);?>" alt="image" onerror="this.onerror=null; this.src='assets/images/dealer-logo.jpg';">
    <!-- <input type="file" class="upload_button" value="upload" style="position: absolute; bottom: 5px; right: 5px;"> -->
</div>
