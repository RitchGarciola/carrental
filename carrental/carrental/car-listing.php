        ...
        <div class="product-listing-m gray-bg">
          ...
          <div class="product-listing-content">
            ...
            <ul>
              ...
              <li><i class="fa fa-cogs" aria-hidden="true"></i><?php echo htmlentities($result->ModelYear);?> HP</li>
              <li><i class="fa fa-user" aria-hidden="true"></i><?php echo htmlentities($result->Category);?></li>
