		...
		<ul class="ts-sidebar-menu">
			...
			<li><a href="#"><i class="fa fa-sitemap"></i> Bookings</a>
				<ul>
					...
					<li><a href="canceled-bookings.php">Cancelled Bookings</a></li>
					<li><a href="returned-vehicle.php">Returned Vehicles</a></li>
				</ul>
			</li>
			...
			<li><a href="ReportClass.php"><i class="fas fa-calculator"></i> Report</a></li>
			...
			<li><a href="reg-users.php"><i class="fa fa-users"></i>Customer Information</a></li>
