...
$query->execute();
$results=$query->fetchAll(PDO::FETCH_OBJ);
$report=$query->rowCount();
?>
													<div class="stat-panel-number h1 "><?php echo htmlentities($report);?></div>
													<div class="stat-panel-title text-uppercase">Report</div>
												</div>
											</div>
											<a href="ReportClass.php" class="block-anchor panel-footer">Full Detail <i class="fa fa-arrow-right"></i></a>
										</div>
									</div>
									<!--<div class="col-md-3">
										<div class="panel panel-default">
