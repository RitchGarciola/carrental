...
$sql="INSERT INTO tblvehicles(VehiclesTitle,VehiclesBrand,VehiclesOverview,PricePerDay,FuelType,ModelYear,SeatingCapacity,Category,FullTank,Vimage1,Vimage2,Vimage3,Vimage4,Vimage5,AirConditioner,PowerDoorLocks,AntiLockBrakingSystem,BrakeAssist,PowerSteering,DriverAirbag,PassengerAirbag,PowerWindows,CDPlayer,CentralLocking,CrashSensor,LeatherSeats,PlateNumber,Color,Category,HP) VALUES(:vehicletitle,:brand,:vehicleoverview,:priceperday,:fueltype,:modelyear,:seatingcapacity,:trans,:vimage1,:vimage2,:vimage3,:vimage4,:vimage5,:airconditioner,:powerdoorlocks,:antilockbrakingsys,:brakeassist,:powersteering,:driverairbag,:passengerairbag,:powerwindow,:cdplayer,:centrallocking,:crashcensor,:leatherseats,:plate,:color,:trans,:hp,:ft)";
...
$query->bindParam(':plate',$platenumber,PDO::PARAM_STR);
								...
								<div class="panel panel-default">
									...
									<div class="panel-body">
										<form method="post" class="form-horizontal" enctype="multipart/form-data">
											...
											<div class="form-group">
												<label class="col-sm-2 control-label">Price Per Day(in PESO)<span
														style="color:red">*</span></label>
												<div class="col-sm-4">
											...
											<label class="col-sm-2 control-label">Select Transmission<span
														style="color:red">*</span></label>
												<div class="col-sm-4">
											...
											<label class="col-sm-2 control-label">HorsePower<span
														style="color:red">*</span></label>
												<div class="col-sm-4">
											...
											<div class="form-group">
											<label class="col-sm-2 control-label">Color<span
														style="color:red">*</span></label>
												<div class="col-sm-4">
													<input type="text" name="color" class="form-control" required>
												</div>
												<label class="col-sm-2 control-label">Fuel Tank Capacity<span
														style="color:red">*</span></label>
												<div class="col-sm-4">
													<input type="text" name="ft" class="form-control" required>
												</div>
											</div>
