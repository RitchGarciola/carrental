...
$sql="update tblvehicles set VehiclesTitle=:vehicletitle,VehiclesBrand=:brand,VehiclesOverview=:vehicleoverview,PricePerDay=:priceperday,FuelType=:fueltype,ModelYear=:modelyear,SeatingCapacity=:seatingcapacity,Category=:trans,HP=:hp,FullTank=:ft,AirConditioner=:airconditioner,PowerDoorLocks=:powerdoorlocks,AntiLockBrakingSystem=:antilockbrakingsys,BrakeAssist=:brakeassist,PowerSteering=:powersteering,DriverAirbag=:driverairbag,PassengerAirbag=:passengerairbag,PowerWindows=:powerwindow,CDPlayer=:cdplayer,CentralLocking=:centrallocking,CrashSensor=:crashcensor,LeatherSeats=:leatherseats,PlateNumber=:plate,Color=:color where id=:id ";
...
<label class="col-sm-2 control-label">Select Transmisson<span style="color:red">*</span></label>
<div class="col-sm-4">
<select class="selectpicker" name="trans" required>
...
<div class="form-group">
<label class="col-sm-2 control-label">HorsePower<span style="color:red">*</span></label>
<div class="col-sm-4">
<input type="text" name="hp" class="form-control" value="<?php echo htmlentities($result->HP);?>" required>
</div>
...
<label class="col-sm-2 control-label">Fuel Tank Capacity<span style="color:red">*</span></label>
<div class="col-sm-4">
<input type="text" name="ft" class="form-control" value="<?php echo htmlentities($result->FullTank);?>" required>
</div>
</div>
...
<div class="col-sm-4">
<input type="text" name="plate" class="form-control" value="<?php echo htmlentities($result->PlateNumber);?>" required>
</div>
